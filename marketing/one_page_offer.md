# Chiropractic Business OS: One-Page Offer
...
- Patient-friendly CSV exports
- Chiropractic sample data for demos
...
- Local or hosted demo setup
- Chiropractic branding and sample data update
- Basic walkthrough with owner or office manager

### Practice Launch - $1,500

- Hosted deployment guidance
- Custom sample data and practice terminology
- One round of UI copy polish
- Export workflow review
- 7 days of light support

### Workflow Polish - $3,000

- Practice-specific dashboard refinements
- Follow-up workflow cleanup
