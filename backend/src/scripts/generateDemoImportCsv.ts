...
function buildRows(): Row[] {
  return [
    // Importable. Lands in the Overdue queue at 14 days past the expected return.
    {
      ...
      'Activity / Movement Context': 'Monthly wellness patient; mobility maintenance goal.',
      Source: 'Referral',
    ...
    // Importable. Lands in the Due Today queue.
    {
      ...
      'Activity / Movement Context': 'Desk worker; recurring neck and upper back stiffness.',
      Source: 'Phone Call',
    ...
    // Importable. Lands in the Upcoming queue seven days out.
    {
      ...
      'Activity / Movement Context': 'Active adult; wants to stay ready for weekend tennis.',
      Source: 'Website',
      'Patient Type': 'Existing Patient',
      'Appointment Status': 'Not Scheduled',
    ...
    // Duplicate. Matches a seeded patient by email and phone, so the importer skips it.
    {
      ...
      'Requested Service': 'Wellness Consultation',
      'Activity / Movement Context': 'Reactivation; evening visits fit her schedule.',
      Source: 'Referral',
      'Patient Type': 'Existing Patient',
      'Appointment Status': 'Not Scheduled',
    ...
    // Invalid. US-formatted date, the most common real clinic export problem.
    {
      ...
      'Activity / Movement Context': 'Warehouse work; lifting-related back discomfort.',
      Source: 'Google',
      'Patient Type': 'Existing Patient',
      'Appointment Status': 'Not Scheduled',
